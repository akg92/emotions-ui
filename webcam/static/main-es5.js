...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _match_match_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./match/match.component */
    "./src/app/match/match.component.ts");
    /* harmony import */
  ...
  function srcAppMatchMatchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _proto.loadImage2 = function loadImage2(file) {
        var url = this.imageLoadUrl + file;
      ...
      _proto.loadSim = function loadSim() {
        var _this3 = this;

        var url = this.matchLoadUrl + this.imageList[this.curIndex];
        this.http.get(url).subscribe(function (res) {
          var files = res;
  ...
  function srcAppUploadUploadComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function UploadComponent(http) {
        this.http = http; // toggle webcam on/off
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/shibin/Downloads/Research/emotions-ui/webcam/frontend/fexp-ui/src/main.ts */
    "./src/main.ts");
    /***/
  }
